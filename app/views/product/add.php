...
<?php endif; ?>
<form method="POST" action="/mini_ecommerce/Product/update" enctype="multipart/form-data" onsubmit="return validateForm();">
...
<a href="/mini_ecommerce/Product/list" class="btn btn-secondary mt-2">Quay lại danh sách sản phẩm</a>
...
<?php endif; ?>
<form method="POST" action="/mini_ecommerce/Product/save" enctype="multipart/form-data" onsubmit="return validateForm();">
    <div class="form-group">
        <label for="name">Tên sản phẩm:</label>
